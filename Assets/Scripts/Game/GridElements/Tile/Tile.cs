...
public class Tile : MonoBehaviour {
	...
	public virtual void Speak (string str, Color color, float delay = 0, bool stick = false, int fontSize = 16) {
		//if (!visible) { return; }

		Hud.instance.CreateLabel(this, str, color, delay, stick, fontSize);
	}
